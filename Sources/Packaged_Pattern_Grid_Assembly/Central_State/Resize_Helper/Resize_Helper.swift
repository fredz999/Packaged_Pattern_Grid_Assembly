            ...
            if dimensions.patternTimingConfiguration == .fourFour {
                for note in highlightSet {
                    ...
                    if snapshot_Note_Cells_Left_Of_Note_Set.count == 0 {
                        ...
                        newResizeGarage.available_Cell_Set = snapshot_Line_Set.filter{$0.dataCell_X_Number > -1 && $0.dataCell_X_Number < note.highest_X_Index}
                        ...
                        newResizeGarage.new_Note_Cell_Set = Set(note.dataCellArray)
                        newResizeGarage.available_Cell_Set = snapshot_Line_Set.filter{$0.dataCell_X_Number > maxNoteCellLeftOfNote.dataCell_X_Number && $0.dataCell_X_Number < note.highest_X_Index}
        ...
        if let lclNoteCollection = parentCentralState.currentNoteCollection {
            ...
            if dimensions.patternTimingConfiguration == .fourFour {
                ...
                let newResizeGarage = Right_Side_Resizer_Garage(snapshotMinHalfCellIndex: note.lowestFourFourHalfCellIndex
                                                                , snapshotMaxHalfCellIndex: note.highestFourFourHalfCellIndex
                                                                , rightwardBarrierDataXParam: dimensions.dataGrid_X_Unit_Count, leftwardBarrierDataXParam: note.lowest_X_Index
                                                               , snapshot_Line_Set: snapshot_Line_Set, noteParam: note, resizeModeParam: resizeSubMode)
                
                newResizeGarage.new_Note_Cell_Set = Set(note.dataCellArray)
                newResizeGarage.available_Cell_Set = snapshot_Line_Set.filter{$0.dataCell_X_Number > note.highest_X_Index && $0.dataCell_X_Number < dimensions.dataGrid_X_Unit_Count}
                ...
                let newResizeGarage  = Right_Side_Resizer_Garage(snapshotMinHalfCellIndex: note.lowestFourFourHalfCellIndex
                                                                    , snapshotMaxHalfCellIndex: note.highestFourFourHalfCellIndex
                                                                 , rightwardBarrierDataXParam: minNoteCellRightOfNote.dataCell_X_Number, leftwardBarrierDataXParam: note.lowest_X_Index
                                                                , snapshot_Line_Set: snapshot_Line_Set, noteParam: note, resizeModeParam: resizeSubMode)
                newResizeGarage.new_Note_Cell_Set = Set(note.dataCellArray)
                newResizeGarage.available_Cell_Set = snapshot_Line_Set.filter{$0.dataCell_X_Number > note.highest_X_Index && $0.dataCell_X_Number < minNoteCellRightOfNote.dataCell_X_Number}
                right_Side_Resizer_Garage_Array.append(newResizeGarage)
                }
                ...
                let snapshot_Right_Cursor_Set = snapshot_Note_Set.filter{$0.six_Eight_Half_Cell_Index == note.highestSixEightHalfCellIndex}

                let snapshot_Cells_Right_Of_Note_Set = snapshot_Line_Set.filter{$0.six_Eight_Half_Cell_Index > note.highestSixEightHalfCellIndex}
                ...
                if snapshot_Group_MaxHalfCellIndex == nil {
                    if let lclNoteCollection = parentCentralState.currentNoteCollection {
                        if let lclCurrNoteUnderCursor = lclNoteCollection.note_Currently_Under_Cursor {
                            if note.id == lclCurrNoteUnderCursor.id {
                                snapshot_Group_MaxHalfCellIndex = note.highestSixEightHalfCellIndex
                                if let hSliderRef = parentCentralState.h_Slider_Ref {
                                    if let maxCursorCell = snapshot_Right_Cursor_Set.max(by: {$0.dataCell_X_Number < $1.dataCell_X_Number}){
                                        let destinationCellIndex = maxCursorCell.dataCell_X_Number
                                        hSliderRef.jumpToACell(cellNum: destinationCellIndex)
            ...
            for resizer in left_Side_Resizer_Garage_Array {
                if let lclNoteRef = resizer.noteReference {
                    ...
                    if resizer.new_Note_Cell_Set.count == 1 {
                        ...
                        lclNoteRef.lowest_X_Index = newCellArray[0].dataCell_X_Number
                        lclNoteRef.highest_X_Index = newCellArray[0].dataCell_X_Number
                        ...
                        lclNoteRef.highest_X_Index = newCellArray[1].dataCell_X_Number
                        for cell in newCellArray{
                            if cell.in_Resize_Set == true {cell.handleVisibleStateChange(type: .deActivate_Resize_Set)}
                            if cell.note_Im_In != resizer.noteReference{cell.note_Im_In = lclNoteRef}
                        }
                        ...
                        lclNoteRef.lowest_X_Index = newCellArray[firstIndex].dataCell_X_Number
                        ...
                        lclNoteRef.highest_X_Index = newCellArray[finalIndex].dataCell_X_Number
                        for cell in newCellArray {
                            if cell.in_Resize_Set == true {cell.handleVisibleStateChange(type: .deActivate_Resize_Set)}
                            if cell.note_Im_In != resizer.noteReference{cell.note_Im_In = lclNoteRef}
                        }
