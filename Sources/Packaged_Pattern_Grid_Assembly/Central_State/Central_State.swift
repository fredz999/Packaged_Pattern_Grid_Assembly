...
public class Central_State : ObservableObject {
    ...
    ,"cell six_Eight_Half_Cell_Index: ",viableSetHelpers.helperFuncs_currentData.six_Eight_Half_Sub_Index.description
    ,"cell six_Eight_Half_Cell_Index: ",viableSetHelpers.helperFuncs_currentData.four_Four_Half_Sub_Index  .description)
