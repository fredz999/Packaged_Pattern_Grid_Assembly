...
//class Central_State : ObservableObject {
//
//    @Published var write_Note_Button_Visible : Bool = true
...
//    var note_Collection_Ref : Note_Collection?
//
//    //var potentialLayer2 : //Potential_Note_Layer_Store<T>?
//    var potential_Note_Layer_Ref : Potential_Note_Layer_Store<VariableWidthRecView>?
//    var h_Slider_Ref : Cursor_Horizontal_Slider_Store<H_Slider_View_External,H_Slider_Line_View_External>?
//    var v_Slider_Ref : Cursor_Vertical_Slider_Store<V_Slider_View_External, V_Slider_Line_View_External>?
...
//
//    if let lcl_Visual_Grid = cStateVisualGridRef{
//        lcl_Visual_Grid.changeDataBracket(newLower: newLower)
//    }
//
//    centralState_Data_Evaluation()
//    }
...
//    }
//
//    static let Static_Central_State = Central_State()
//
//}
